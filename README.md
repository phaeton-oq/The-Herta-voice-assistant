...
Четыре вещи pip поставить не может. Установщик проверит их наличие и напечатает точные команды для твоей системы, но саму установку надо запустить самому.
