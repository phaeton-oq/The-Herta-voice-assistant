...
def _strip_inline_markup(cell: str) -> str:
    ...
    Порядок важен: сначала парные звёздочки, иначе одиночная съест половину
    жирного и оставит мусор. Подчёркивания не трогаем — в таблицах сплошь
    имена вроде snake_case_name, и «курсив» там почти всегда ложный.
    """
